...
# No OMZ theme — the prompt is Powerlevel10k, sourced below. Loading an OMZ
# theme here would just be replaced (and slow startup slightly).
ZSH_THEME=""
...
plugins=(git sudo zsh-autosuggestions zsh-syntax-highlighting z aws)
